...
const UNITS = {
  ...
  /* --------------------------------------------------------------
     ...
     -------------------------------------------------------------- */
  /* --------------------------------------------------------------
     ★ネコス★（うらステージ「さいごの しょうぶ」だけの ゲスト）

     おみせの てんしゅ……の すがたを した、かつての でんせつの せんし。
     タンクンが やられる ちょくぜんに かけつけて、いっしょに たたかいます。

     ★このステージ だけの ゲスト です。★
       ・ガチャには でません（ALL_CHARS に いれて いません）
       ・ずかんにも、ほかの ステージにも でて きません
       ・レベルは いつも Lv.20 で こていです（ステージの guestChars）

     やくわり：タンクンは かべ（こうげき 22）なので、
               ダメージは ぜんぶ ネコスが だします。
     -------------------------------------------------------------- */
  nekos: {
    id: 'nekos', name: 'ネコス', shortName: 'ネコス',
    rarity: 'LR',
    attr: 'god',                         // かみ（てんさい せんし）
    cost: 900,                           // ★たかい。ぽんぽんは だせない
    recharge: 20,                        // ★1たい だすのに 20びょう
    hp: 4550,                            // ★ターツーマーキーの こうげきを 2はつ たえる
    atk: 980,
    range: 178,
    speed: 30,
    attackInterval: 1.5,
    attackWindup: 0.34,
    kbCount: 4,
    scale: 1.55,                         // え を 0.72ばいに して いる ぶん もどす
    attackType: 'area',  areaRadius: 92,
    projectile: null,
    drawAs: 'nekos_fight',
    /* りょうての やじるしで 2れんげき */
    multiHit: { count: 2, delay: 0.18 },
    /* でんせつの せんし ── みきりが するどい */
    dodge: 0.25,
    crit: { chance: 0.20, mult: 2.0 },
    /* ★ふきとばされません（v6.49）。
         でんせつの せんし なので、なにが あたっても うしろに さがらず、
         その ばで うちかえします。ターツーマーキーの かぜでも うごきません。*/
    kbImmune: true,
    slowImmune: true, stunImmune: true,
  },
...
const ENEMIES = {
  ...
  /* --- ターツーマーキー【1コースめ・ぜったいに かてない すがた】---

       ものがたりの ための てきです。
       ステージに unbeatable: true が ついて いるので、
       ★どんなに がんばっても しろは こわれません★。
       たいりょくも こうげきも けたちがい。ぜんめつ するのが「せいかい」で、
       まけた あとに ネコスの ムービーが はじまります。                */
  tatsumarky: {
    id: 'tatsumarky', name: 'ターツーマーキー',
    rarity: 'LR',
    attr: 'god',                          // かみ
    hp: 9999999,                          // ★じっしつ むげん
    atk: 99999,                           // ★なにが きても 1げき
    range: 320,   speed: 30,
    attackInterval: 0.9,   attackWindup: 0.30,
    kbCount: 99999, scale: 1.7,
    attackType: 'area',  areaRadius: 260,  projectile: 'beam',
  ...
  /* --- ターツーマーキー【うらステージ・ほんとうの しょうぶ】---

       ネコスと タンクン だけで いどむ さいしゅうせん。
       つよさは「スーパーたんくん Lv.40 ＋ ネコス Lv.20 の ふたりで
       30かい いどんで 5かい くらい かてる」ように あわせて あります。

       ・たつまきを まきちらす ひろい はんい こうげき
       ・ふきとばし・スタン・どんそくは ぜんぶ きかない
       ・たいりょく はんぶんで ほんきに なる（enrage）
       ・ざこは よばない（タイマン）                                   */
  tatsumarky_true: {
    id: 'tatsumarky_true', name: 'ターツーマーキー',
    rarity: 'LR',
    attr: 'god',
    hp: 62000,
    /* ★こうげきりょくは ここで こてい。
         ネコス Lv.20（たいりょく 13,195）に たいして 1げき 4,800 なので、
         ★かならず 2はつは たえられます★（3はつめで たおれる）。
         なんいどを いじる ときは この あたいを さわらないで ください。 */
    atk: 4000,
    range: 196,   speed: 34,
    attackInterval: 1.4,   attackWindup: 0.42,
    kbCount: 99, scale: 1.7,
    attackType: 'area',  areaRadius: 105,  projectile: 'beam',
    drawAs: 'tatsumarky',
    /* ★しょうぶを「うんも ある たたかい」に する ための ゆらぎ。
         つよさを あげさげ する だけでは、かちりつが 100%か 0%かに
         ふりきれて しまい、ちょうどいい ところが ありません。
         かわす・ふきとばす・かいしんの いちげき の 3つで、
         1かい 1かいの けっかが おおきく かわる ように して います。   */
    dodge: 0.35,                           // たつまきに まぎれて かわす
    knockbackChance: 0.30,                 // かぜで ふきとばす
    crit: { chance: 0.25, mult: 1.6 },     // かいしんの たつまき
    /* ★たいりょく はんぶんで「ほんき」。
         ★こうげきりょくは あげません（atkMult: 1.0）。★
         あげると「2はつ たえる」やくそくが くずれます。
         そのかわり こうげきの かんかくが 1.4 → 0.66びょう に なります。
         ここからが ほんとうの しょうぶ で、この あいだに たおしきれるか
         どうかで かちまけが きまります。                               */
    enrage: { below: 0.5, atkMult: 1.0, intervalMult: 0.47 },
    kbImmune: true, stunImmune: true, slowImmune: true,
    money: 0,
    isBoss: true,
  },
...
const BACKGROUNDS = {
  ...
  stormplain: {
    sky: ['#1a1526', '#3a2f52', '#6f5f86'],
    hillFar: '#4c4166', hillNear: '#2c2440',
    ground: '#39304c', groundTop: '#5a4c74',
    deco: 'rock',
  },
...
const STAGES = [
  ...
  /* ==========================================================================
     18しょう「ターツーマーキーが支配する平原」（コース 2つ）

     1コースめ ★ぜったいに かてません★（unbeatable: true）
       ものがたりの ための たたかいです。しろは こわれず、
       ぜんめつ すると そのまま ネコスの ムービーに つながります。

     2コースめ ★うらステージ★
       1コースめを おえると あらわれます。
       つかえる なかまは タンクンと ネコスの ふたり だけ（allowChars）。
       ネコスは この コースだけの ゲストで、いつも Lv.20 です（guestChars）。
     ========================================================================== */
  {
    no: 142, chapter: 18, course: 1,
    name: 'ターツーマーキーの へいげん',
    desc: '★ものがたり★ 3大王を たおした ごうのすけたち の まえに、ターツーマーキー ほんにんが たちはだかる。',
    bg: 'stormplain',
    castleHp: 4000,
    power: 1,
    /* ★かてない たたかい。しろは ぜったいに こわれません */
    unbeatable: true,
    loseIsClear: true,       // ぜんめつ しても クリア あつかい（ものがたりが すすむ）
    drops: [],
    reward: { coins: 0, exp: 0 },
    waves: [
      /* ★はじまって すぐ ほんにんが でて くる */
      { at: 1.5, id: 'tatsumarky', count: 1 },
    ],
  },
  {
    no: 143, chapter: 18, course: 2,
    name: 'さいごの しょうぶ',
    desc: '★うらステージ★ タンクンと ネコス、ふたり だけの さいしゅうせん。',
    bg: 'stormplain',
    castleHp: 5200,
    /* ★power は 1 の まま つかいません。
         power は hp と atk を いっしょに うごかして しまうので、
         「ネコスが 2はつ たえる」を きめた あとで なんいどを いじると
         こうげきりょくまで かわって やくそくが くずれます。
         なので つよさは ENEMIES.tatsumarky_true の hp で あわせて います。*/
    power: 1,
    /* ★つかえるのは この ふたり だけ */
    allowChars: ['tankun', 'nekos'],
    /* ★ネコスは この コースだけの ゲスト。いつも Lv.20 */
    guestChars: { nekos: 20 },
...
const CHANGELOG = [
  {
    ...
    items: [
      'エンディングの あとはんを かきなおしました。ウイルスに のっとられた タンクンは、★ゆっくりと ほうしんを なかまに むけます。★',
      '「タンクン、やめて！ わたしだよ、ぷりおだよ！」── その めには、もう だれも うつって いません。',
      'ひとふりで いわが くだけます。★まえより ずっと つよい。★ みんな よけるので せいいっぱい でした。',
      'そして タンクンは ほえると、だれも いない ★きたの ほう★ へ はしりさって いって しまいます。',
      'ネコス「……あれは もう てき じゃ。」──「いや。★まだ タンクンじゃ。かならず つれもどす。★」',
      'つぎの しょうは、★なかまを とりもどす たび★ に なります。',
    ],
  },
  {
    ver: '6.50', date: '2026-09-26',
    title: 'エンディングを 「★つづく★」 に かきかえました',
    items: [
      'ターツーマーキーを たおした あとの ムービーが、「めでたし めでたし」で おわらず ★つぎの しょうへ つづく★ ながれに なりました。',
      'かえりみち、タンクンの ようすが きゅうに おかしく なります。★ぷりおぷりねこ★ が「どうしたの！」と かけよると、タンクンの からだの すきまから ★くろい もや★ が あふれだします。',
      'ターツーマーキーが もって いた ★ウイルス★ でした。めが まっかに ひかって、★タンクンが きょうらん★ します。',
      'きょうらんした タンクンは ひとふりで いわを くだく ほど つよく なって います。……でも、ずっと くるしそうに うなって います。',
      'ネコスは この もやを しって いました。「このままでは タンクンの からだが もたん。★くすりを さがすんじゃ。★」',
      'たつまきは おわりましたが、あたらしい たびが はじまります。★つぎの しょうへ つづく。★',
      'きょうらんタンクンの えを あたらしく かきました（どすぐろい むらさき・まっかな め・ひびわれ・たちのぼる くろい もや）。',
    ],
  },
  {
    ver: '6.49', date: '2026-09-26',
    title: 'ネコスが ★ふきとばされなく★ なりました',
    items: [
      'ターツーマーキーの こうげきを うけても、ネコスは ★うしろに さがりません★。でんせつの せんし なので、なにが あたっても その ばで うちかえします。',
      'これまでは かぜで ふきとばされて、また あるいて もどる あいだ こうげきが とまって いました。',
      'そのぶん ★かなり かちやすく なりました★（3かいに 1かい → 4かいに 3かい くらい）。',
      'ネコスが 2はつ たえる ことは かわって いません。',
    ],
  },
  {
    ver: '6.48', date: '2026-09-26',
    title: '「さいごの しょうぶ」の なんいどを さげました（3かいに 1かい かてる）',
    items: [
      'ネコスが ★ターツーマーキーの こうげきを かならず 2はつ たえられる★ ように なりました。まえは 2はつで たおれて、かいしんの いちげきが でると ★1はつで きえて★ いました。',
      'げんいんは「かみ ぞくせい どうしは ダメージが 1.2ばい に なる」ことを みおとして いた ことです。ネコスの たいりょくを 3,200 → 4,550 に あげて、1げきの ダメージを 4,800 に こていしました。',
      'かちりつを ★30かいで 5かい → 3かいに 1かい★ に あげました（270かい はかって 95かち）。',
      '★ターツーマーキーが「ほんきモード」に なる ときの かわりかたを かえました。★ たいりょくが はんぶんに なると、こうげきりょくは そのままで ★こうげきの はやさが 2ばい ちかく★ に なります。ここからが ほんとうの しょうぶ です。',
      'こうげきりょくを あげない ように したので、ほんきモードでも ★ネコスは 2はつ たえられます★。',
    ],
  },
  {
    ver: '6.47', date: '2026-09-26',
    title: '★さいしゅうしょう「ターツーマーキーが支配する平原」★ と ムービー 3ぼん',
    items: [
      'たつまきちずの ならびを なおしました。「埃にまみれた都市」が ひだりうえに ぽつんと あったのを、ほかと おなじく ★いちばん みぎ★ に うつして います。',
      '★埃にまみれた都市を クリアすると ムービーが ながれます。★ 3大王を ぜんぶ たおした ごうのすけたち の まえに ターツーマーキーが おりて きて、「みくびって おった」と みとめ、★じきじきに あいてを する★ と いいます。',
      '★あたらしい ばしょ「ターツーマーキーが支配する平原」★ が あそべる ように なりました。はじまって すぐ ターツーマーキー ほんにんが でて きます。',
      '……ですが、この たたかいは ★ぜったいに かてません★。たいりょくも こうげきも けたが ちがいます。ぜんめつ するのが せいかい なので、「まけた」では ありません。',
      '★ぜんめつ すると ムービーが ながれます。★ さいごに のこった タンクンに とどめが おりる ちょくぜん、おみせの ★ネコス★ が たすけに きます。じつは むかし、たつまきに たった ひとりで たちむかった ★でんせつの せんし★ でした。',
      '★うらステージ「さいごの しょうぶ」★ が あらわれます。つかえる なかまは ★タンクンと ネコスの ふたり だけ★。ネコスは この ステージだけの ゲストで、いつも Lv.20 です。',
      'タンクンは こうげきりょくが 64 しか ない かべ なので、ダメージは ぜんぶ ネコスが だします。「タンクンが たえて いる あいだに ネコスが けずる」たたかい です。',
      'つよさは ★30かい いどんで 5かいくらい かてる★ ように あわせました（270かい はかって 48かち）。かなり むずかしい ので、なんども ちょうせん して ください。',
      '★かつと さいごの ムービーが ながれます。★ ながい たつまきが やっと やんで、まちに ふつうの まいにちが もどって きます。',
      'ムービーは いちど ながれれば、ホームの「ムービー」から いつでも みなおせます。',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      'せが たかすぎた ので、★2とうしん ちょっと★（あたまが おおきくて せが ひくい）に なおしました。',
      'どうも よこに ひろく、あしも みじかく。スリッパも おおきめに して、あしもとを どっしり させて います。',
      'かおの おおきさは そのまま なので、ニヤッと わらった かおは よく みえます。',
    ],
  },
  {
