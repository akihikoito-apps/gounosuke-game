...
const UNITS = {
  ...
  tatamin: {
    ...
    /* ------------------------------------------------------------
       しんか：じつりょく Lv.10 で「柔道たたみん」に なれます
...
const CHANGELOG = [
  {
    ...
    items: [
      'たたみんが じつりょく Lv.10 で「柔道たたみん」に しんか できる ように なりました。じゅうどうぎに オレンジの おび すがたです。',
      '柔道たたみんは たいりょくが 1.5ばい（1300→1950）に なり、じゃまが なかなか きかない かべやくです。ふきとばし・どんそく・うごきとめ が ぜんぶ きかず、クモの巣の なかでも はやさが おちません。',
