...
const ENEMIES = {
  ...
  tatsumarky_true: {
    ...
    atk: 4200,
    range: 196,   speed: 34,
    attackInterval: 1.7,   attackWindup: 0.42,
    kbCount: 99, scale: 1.7,
    ...
    crit: { chance: 0.25, mult: 2 },       // かいしんの たつまき
    enrage: { below: 0.5, atkMult: 1.4, intervalMult: 0.72 },
    kbImmune: true, stunImmune: true, slowImmune: true,
    money: 0,
    isBoss: true,
  },
...
const STAGES = [
  ...
  },
  {
    ...
    bg: 'stormplain',
    castleHp: 5200,
    /* ★30かい いどんで 5かいくらい かてる つよさ。
         スーパーたんくん Lv.40 ＋ ネコス Lv.20 で 270かい はかって
         48かち（17.8%）＝ 30かいで 5.3かい。                        */
    power: 1.30,
    /* ★つかえるのは この ふたり だけ */
