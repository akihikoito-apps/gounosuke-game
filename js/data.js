...
const CHANGELOG = [
  {
    ...
    title: 'ドズル社プラネット さいしゅうステージの なんいど ちょうせい',
    items: [
      '「ドズル社 ビル さいじょうかい」が むずかしすぎて、なかなか きめてが うてない ことが ありました。てきの つよさを すこし さげました（クリアまで やく 170びょう）。',
      'ほかの 1〜5ステージは そのまま です。',
      'なんいどを はかる テストの やりかたを なおしました。これまでは しんかご の キャラの ねだんを ただしく みて いなくて、たかい しんかキャラ（マッチ様 600えん など）が でにくく なって いました。じっさいの あそびかたに あわせて、レベルだけで なく しんかも させた じょうたいで はかって います。',
    ],
  },
  {
